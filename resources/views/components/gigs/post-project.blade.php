...
<form method = 'POST' action="/jobs/show" enctype="multipart/form-data">
    @csrf
        ...
        <div class="row">
            <div class="col-md-3 border-right">
                <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                    ...
                    @enderror
                    <span class="font-weight-bold">Edogaru</span><span class="text-black-50">click to choose an image for the project</span><span> </span></div>
            </div>
            <div class="col-md-5 border-right">
                <div class="p-3 py-5">
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-md-6"><label class="labels">Offer</label>
                            <input type="text" class="form-control" name="offer" placeholder="Offer" required>
                            @error('offer')
                            <p class="text-red-500 text-xs mt-1">{{$message}}</p>
                            @enderror
                        </div>
                    ...
                    <button class="btn btn-primary profile-button" type="button" onclick="addInput()">more </button>
